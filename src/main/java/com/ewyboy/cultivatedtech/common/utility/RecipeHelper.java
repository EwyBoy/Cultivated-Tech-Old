...
public class RecipeHelper {
    ...
    public static void setupDir() {
        if (RECIPE_DIR == null) {
            RECIPE_DIR = ConfigLoader.config.getConfigFile().toPath().resolve("../recipes").toFile();
            Logger.info(ConfigLoader.config.getConfigFile().toPath().resolve("../recipes").toFile().getPath());
        }
