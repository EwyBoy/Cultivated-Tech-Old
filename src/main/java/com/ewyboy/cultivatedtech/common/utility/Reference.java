...
public class Reference {
    ...
    public static final class Info {
        ...
        public static final String VERSION = "17w47-C-1.12.2";
        public static final String DEPENDENCIES = "required-after:bibliotheca@[1.1.0-1.12.2,);required-after:redstoneflux@[1.12-2.0.1.2,);";
    }
